...
# else:
nodes2idx_path = 'cached_seeds_and_embeddings/{}/{}_node2idx.pk'.format(dataset, rule_type)
pos_seeds_path = 'cached_seeds_and_embeddings/{}/{}_Pos_Seeds.pk'.format(dataset, rule_type)
neg_seeds_path = 'cached_seeds_and_embeddings/{}/{}_Neg_Seeds.pk'.format(dataset, rule_type)
nodes_embedding_path = 'cached_seeds_and_embeddings/{}/{}_node_embeddings.pk'.format(dataset, rule_type)
edge_path = 'cached_seeds_and_embeddings/{}/{}_edges.pk'.format(dataset, rule_type)
